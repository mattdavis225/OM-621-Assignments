...
**Conclusion**: A one-size-fits-all forecast will not work. Accurate forecasting requires **mode-specific models**.
...
├── data/                       # (Dataset not included – proprietary/fictitious)
├── visuals/                    # Key charts and storyboard images
├── powerbi/                    # Concept dashboard files
└── README.md                   # This file
